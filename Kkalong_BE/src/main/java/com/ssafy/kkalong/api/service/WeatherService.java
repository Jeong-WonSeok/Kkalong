...
public class WeatherService {
    public Map<String, String> loadTodayWeather(String nx, String ny, String baseDate, String baseTime) throws IOException, JSONException {
        ...
        String serviceKey = "DYiaMUNcPjHkreQ50pyzW6tyOdbCv1asjoM0epV/4uwzon0H2yeVj6Y+CVJiUsoDZOtG5189mWT7bVw64VK6YA==";

        StringBuilder urlBuilder = new StringBuilder(apiUrl);
        urlBuilder.append("?" + URLEncoder.encode("ServiceKey", "UTF-8") + "="+serviceKey);
        urlBuilder.append("&" + URLEncoder.encode("dataType","UTF-8") + "=" + URLEncoder.encode("json", "UTF-8"));	/* 타입 */
        urlBuilder.append("&" + URLEncoder.encode("numOfRows","UTF-8") + "=" + URLEncoder.encode("1500", "UTF-8"));	/* 타입 */
    ...
    public Map<String, String> loadWeekWeather(String nx, String ny, String baseDate, String baseTime) throws IOException, JSONException {
